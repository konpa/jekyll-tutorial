 ...
 */
gulp.task('jekyll-build', ['image-magnification'], function (done) {
 ...
 */
gulp.task('jekyll-build-prod', ['image-magnification'], function (done) {
    browserSync.notify(messages.jekyllBuild);
 ...
 * Image magnification
 */
gulp.task('image-magnification', function () {
